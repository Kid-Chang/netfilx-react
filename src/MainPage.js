    ...
    return (
        <>
            <div>
                ...
                style={{ width: "98.5vw" }}
              /> */}
                            <header id="navigater" ref={headerLayer}>
                            ...
                            >
                                <div
                                    ...
                                    style={{ backgroundColor: "rgba(0,0,0,0)" }}
                                >
                                    말기 암 진단이 그를 범죄의 세계로 밀어
                                    넣었다. 아니, 그런 줄 알았다. 제자와 함께
                                    메스를 제조하기로 한 것은 순전히 가족을
                                    지키려는 결정이었건만, 악과 타협한 그 순간,
                                    그는 다가올 거대한 제국을 선택한 것이었다.
                                </div>
                                <div
                                    style={{
                                        height: "20px",
