...
function MainPage(){
    ...
    const Top10Contents =[ 
        {
            index:1,
            rank: <svg id="rank-1" height="10vw" viewBox="-20 0 70 154" className="svg-icon svg-icon-rank-1 top-10-rank">
        ...
        {
            index:2,
            rank: <svg id="rank-2" height="10vw" viewBox="0 0 80 154" className="svg-icon svg-icon-rank-2 top-10-rank">
            <path stroke="#595959" stroke-linejoin="square" stroke-width="4"
        ...
        {
            index: 3,
            rank: <svg id="rank-3" height="10vw" viewBox="0 0 80 154" className="svg-icon svg-icon-rank-3 top-10-rank">
            <path stroke="#595959" stroke-linejoin="square" stroke-width="4"
        ...
        {
            index: 4,
            rank: <svg id="rank-4" height="10vw" viewBox="0 0 81 154" className="svg-icon svg-icon-rank-4 top-10-rank">
            <path stroke="#595959" stroke-linejoin="square" stroke-width="4"
        ...
        {
            index: 5,
            rank: <svg id="rank-5" height="10vw" viewBox="0 0 81 154" className="svg-icon svg-icon-rank-5 top-10-rank">
            <path stroke="#595959" stroke-linejoin="square" stroke-width="4"
        ...
        {
            index: 6,
            rank:<svg id="rank-6" height="10vw" viewBox="0 0 81 154" className="svg-icon svg-icon-rank-6 top-10-rank">
            <path stroke="#595959" stroke-linejoin="square" stroke-width="4"
        ...
        {
            index: 7,
            rank: <svg id="rank-7" height="10vw" viewBox="0 0 78 154" className="svg-icon svg-icon-rank-7 top-10-rank">
            <path stroke="#595959" stroke-width="4"
                ...
                stroke-linejoin="square"></path></svg>,
    ...
    <>
        ...
        <div style={{color: "red", backgroundColor: "white"}}>
            <header className="navigater">
                <div className="nav-logo">
                    <img id="logo" style={{height: "31px"}}
                ...
                <div className="nav-option">
                    <ul className="nav-option-items-ul">
                        <li className="option-item"><a className="option-item-select" href="">홈</a></li>
                        <li className="option-item"><a className="option-item-select" href="">TV 프로그램</a></li>
                        <li className="option-item"><a className="option-item-select" href="">영화</a></li>
                        <li className="option-item"><a className="option-item-select" href="">NEW! 요즘 대세 컨텐츠</a></li>
                        <li className="option-item"><a className="option-item-select" href="">내가 찜한 컨텐츠</a></li>
                    </ul>
                </div>
                <div className="nav-search-admin">
                    <div className="nav-search">
                        <button><img src={"img/pngegg.png"} alt="" style={{height: "30px"}} /></button>
                    </div>
                    <div className="nav-alarm">
                        <button><img src={"img/bell.png"} alt="" style={{height: "30px"}} /></button>
                    </div>
                    <div className="nav-user">
                            <img src={location.state} width={"50vw"}
                                alt="" onClick={goUserSelect} />
                    </div>
                </div>
            </header>
            ...
            <div className="main-full">
                <div className="top-video-div" style={{height: "60vw"}}>
                    <div className="top-video">
                        <img id="top-video-vid"
                            ...
                            alt="" style={{width:"98.5vw" }}  />
                        <img id="top-video-logo"
                            ...
                            alt="" />
                        <div id="top-video-desc" style={{backgroundColor: "rgba(0,0,0,0)"}}>
                            <div class="vid-desc" style={{backgroundColor: "rgba(0,0,0,0)"}}>
                                말기 암 진단이 그를 범죄의 세계로 밀어 넣었다. 아니, 그런 줄 알았다. 제자와 함께 메스를 제조하기로 한 것은 순전히 가족을 지키려는 결정이었건만, 악과 타협한 그
                                순간, 그는
                                다가올 거대한 제국을 선택한 것이었다.
                            </div>
                            <div style={{height: "20px", backgroundColor: "rgba(0,0,0,0)"}}></div>

                            <button class="vid-play"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <button class="vid-info"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="Hawkins-Icon Hawkins-Icon-Standard">
                ...
                <div className="hot-now-contents-div">
                    ...
                    <div className="hot-now-contents">
                    {/* 여기에 jsx 이용. */}
                        {HotNowContents.map(HotNowContent => (
                        <HotItemLayout index={HotNowContent.index} src={HotNowContent.src} title={HotNowContent.title } key = {HotNowContent.index}  />
                        ))}
                    </div>
                </div>
                <br/><br/><br/>
                <div className="top-10-div">
                    ...
                    <div className="top-10-contents">
                    {Top10Contents.map(Top10Content => (
                    <Top10Layout rank={Top10Content.rank} index={Top10Content.index} src={Top10Content.src} title={Top10Content.title } key = {Top10Content.index}  />
                    ))}
